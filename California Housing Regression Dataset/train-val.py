...
dense1 = tflearn.fully_connected(input, 20, activation='relu', 
...
model = tflearn.DNN(net, 
					...
					checkpoint_path='checkpoints/train-val/2layers-20-10_relu_adam_lr-0.02/checkpoints')

# Start training (apply gradient descent algorithm)
model.fit(train_data, train_labels, 
			n_epoch=200, batch_size=None, validation_set=(test_data, test_labels), 
			show_metric=False, snapshot_step=500, run_id="2layers-20-10_relu_adam_lr-0.02")
